...
<div class="page-layout">
  ...
  <main class="doc-content">
    <header class="hero">
      <span class="hero-tag">ltbot / Vue 前端</span>
      <h1>ltbot 前端开发记录</h1>
      <p class="hero-desc">ltbot AI 效率工作台的前端开发时间线，由资深前端数字同事维护。</p>
    </header>
    {content}
    <footer class="page-footer">
      <p>档案生成时间：{now} · 源文件：references/dev-history.md · 维护者：ltbot 资深前端数字同事</p>
    </footer>
  </main>
</div>
<script>
